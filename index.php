...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Smart Gas</a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#services">Usage</a></li>
          <li><a href="#portfolio">Brand</a></li>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Supply and Delivery</h2>
                <p>We offer different brands</p>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/13.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Usage</h2>
                <p>know your usage </p>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p>We are a Smart Gas Meter Company!</p>
        </header>
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              ...
              <p>
                To allow our customers be able to traack their usage.
              </p>
            </div>
          </div>
  ...
  <br><br>
    ...
    <script>
      //Submit name data when enter key is pressed
        $('#vendor').keydown(function(e) {
          ...
          data: JSON.stringify({fname: firstname,lname:lname, quantity: quantity, vendor: vendor })
        })
                .done(function(data) {
                    if(data && data.name){
                        if(data._id)
